...
For example, if the user focuses the camera on a word , he will be able to view a complete virtual 3-D image of that. Moreover ,the user will able to  control the movements of it,to have a complete visualisation of the thing. 
